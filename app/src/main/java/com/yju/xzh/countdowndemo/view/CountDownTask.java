package com.yju.xzh.countdowndemo.view;
...
public class CountDownTask {
    ...
    public CountDownTask countDown(View view, long millis, long countDownInterval, CountDownTimers.OnCountDownListener listener) {
